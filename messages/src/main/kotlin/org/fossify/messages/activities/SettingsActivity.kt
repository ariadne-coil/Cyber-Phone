...
import org.fossify.messages.databinding.ActivityMessagesSettingsBinding
...
class SettingsActivity : SimpleActivity() {
    ...
    private val binding by viewBinding(ActivityMessagesSettingsBinding::inflate)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val intent = Intent().setClassName(
            packageName,
            "org.fossify.phone.activities.SettingsActivity"
        )
